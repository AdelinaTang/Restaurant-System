...
public class SearchSeatFrame extends javax.swing.JFrame {

    private MaintainSeatControl maintainSeatControl = new MaintainSeatControl();
    private String[] columnNames = {"SeatNo", "SeatAvailability", "SeatSize", "Spaces"};
    private Object[][] data = {};
    ...
    public void action() {
        ...
        ArrayList<Seat> seat = maintainSeatControl.retrieveSeatRecordControl();
        if (!jTextField1.getText().equals("")) {
            for (int i = 0; i < seat.size(); i++) {
                if (seat.get(i).toString().toLowerCase().contains(jTextField1.getText().toLowerCase())) {
                    System.out.println(seat.get(i));
                    detailsTableModel.addRow(new Object[]{seat.get(i).getSeatNo(), seat.get(i).getSeatAvailability(), seat.get(i).getSeatSize(),
                        seat.get(i).getNumberOfChairs()}
                    );
                }
            }
        } else;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchSeatFrame().setVisible(true);
            }
        });
    }
            ...
            jtbMenu.addMouseListener(new java.awt.event.MouseAdapter() {
                public void mouseClicked(java.awt.event.MouseEvent evt) {
                    ...
                    for (int i = 0; i < rowCount; i++) {
                        ...
                        if (row == i) {
                            seat = new Seat(Integer.parseInt(detailsTableModel.getValueAt(i, 0).toString()), detailsTableModel.getValueAt(i, 1).toString(),
                                    detailsTableModel.getValueAt(i, 2).toString(), Integer.parseInt(detailsTableModel.getValueAt(i, 3).toString()));
                            new SeatClick(seat);
                        }
