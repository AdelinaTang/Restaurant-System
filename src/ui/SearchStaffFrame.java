...
public class SearchStaffFrame extends javax.swing.JFrame {
    ...
    private String[] columnNames = {"StaffID", "FirstName", "LastName", "ContactNo", "Email", "Address", "Status", "Password"};
    private Object[][] data = {};
    ...
    public void action() {
        ...
        ArrayList<Staff> staff = maintainStaffControl.retrieveStaffRecordControl();
        if (!jTextField1.getText().equals("")) {
            for (int i = 0; i < staff.size(); i++) {
                if (staff.get(i).toString().toLowerCase().contains(jTextField1.getText().toLowerCase())) {
                    System.out.println(staff.get(i));
                    detailsTableModel.addRow(new Object[]{staff.get(i).getStaffID(), staff.get(i).getFirstName(),
                        staff.get(i).getLastName(), staff.get(i).getContactNo(), staff.get(i).getEmail(),
                        staff.get(i).getAddress(), staff.get(i).getStatus(), staff.get(i).getPassword()}
                    );
                }
            }
        } else;
            ...
            jtbMenu.addMouseListener(new java.awt.event.MouseAdapter() {
                public void mouseClicked(java.awt.event.MouseEvent evt) {
                    ...
                    for (int i = 0; i < rowCount; i++) {
                        ...
                        if (row == i) {
                            staff = new Staff(detailsTableModel.getValueAt(i, 0).toString(), detailsTableModel.getValueAt(i, 1).toString(),
                                    detailsTableModel.getValueAt(i, 2).toString(), detailsTableModel.getValueAt(i, 3).toString(), detailsTableModel.getValueAt(i, 4).toString(), detailsTableModel.getValueAt(i, 5).toString(), detailsTableModel.getValueAt(i, 6).toString(), detailsTableModel.getValueAt(i, 7).toString());
                            new StaffClick(staff);
                        }
